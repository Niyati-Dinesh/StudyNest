...
<body>
  <header>
    <img src="pictures\icon_v2" height="80px" width="80px" class="logo"><h1>StudyNest🌱</h1>
    <nav class="nav2">
    <a href="#"><button class="navbar" id="s" onclick="window.location.href='showtasks.php'"><img src="pictures\subjects.jpeg" alt="subject" height=30px" width="30px" > SUBJECTS</button></a>
