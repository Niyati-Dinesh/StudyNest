...
<header>
    ...
    <a href="#"><button class="navbar" id="pr"><img src="pictures/pfp.jpeg" alt="Profile" height="30px" width="30px"> PROFILE</button></a>
...
<p><b> Email: <?php echo"$email"; ?></b></p><br>
  ...
  flex:1;
  ">
    <div id="subjects" style=
    "display:flex;
    flex-direction:row;
    align-items:center;
    justify-content:center;
    object-fit: cover; 
    margin:10px "><b><?php echo"$subject<br>"; ?>Subjects Added</b></div>
    ...
    align-items:center;
    justify-content:center; 
    margin:10px"><b><?php echo"$task <br>"; ?>Tasks Pending</b></div>
  </div>
